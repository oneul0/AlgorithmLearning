...
int main(){
    int nStudents;
    std::cout << "Class 1의 학생 수를 입력하세요 : ";
    std::cin >> nStudents;

    dynamic_array<student> class1(nStudents);
    for(int i = 0; i<nStudents; i++){
        std::cout << "반의 학생들 이름을 입력하세요 "<<i+1<<": ";
        std::string name;
        int standard;
    ...
    try{
        class1[nStudents] = student{"존", 8};
        std::cout<<"class1 student set out of range without excption"<<std::endl;
        //class1.at(nStudents) = student{"존", 8};
    }
    catch(...){
